...
<details>
<summary>Additional notes: Python vs NumPy</summary>
...
:::{instructor-note} More info
<details>
<summary>Additional notes: `np.uint8`</summary>
...
:::{instructor-note} More info
<details>
<summary>Additional notes: Inspect float-types</summary>
...
<details>
<summary>Additional notes: Primary uses in bioinformatics</summary>
...
```python
print(np.array([1, 2, 3]).dtype)            # Creates int64 array
print(np.array([1.0, 2.0, 3.0]).dtype)      # Creates float64 array
print(np.array([True, False, True]).dtype)  # Creates bool array
print(np.array(['A', 'C', 'G', 'T']).dtype) # Creates string array
```
...
:::{instructor-note} More info
<details>
<summary>Additional notes: Memory Optimization</summary>
...
<details>
<summary>Additional notes: Performance Considerations</summary>
