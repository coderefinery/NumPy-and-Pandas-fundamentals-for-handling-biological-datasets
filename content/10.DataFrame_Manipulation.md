...
|----------------|---------|----------------|
| Single column | Get one series | `df['column_name']` or `df.column_name` |
| Multiple columns | Get specific series | `df[['col1', 'col2']]` |
...
print(df_no_bob)
## df_no_bob = df.drop('emp002', axis=0)
## df_no_bob = df.drop(index='emp002')
...
:::{instructor-note} More info
<details>
<summary>Additional notes: Series-to-DataFrame Conversions</summary>

**Adding a row with a Series:**
